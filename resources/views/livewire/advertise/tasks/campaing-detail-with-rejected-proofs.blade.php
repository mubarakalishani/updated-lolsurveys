                ...
                <div class="row align-items-end mb-4 pb-2">
                  <nav class="mt-0">
                      <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link active"><a href="?tab=rejected">Rejected</a></button>
                        <button class="nav-link"><a href="?tab=revision">Asked Revision</a></button>
                      </div>
                  </nav>
                  <div class="tab-content" id="nav-tabContent">
                    <!-- Rejected task start -->
                    <div class="tab-pane fade show active" id="nav-bonus" role="tabpanel" aria-labelledby="nav-bonus-tab">
