              ...
              <div class="row align-items-end mb-4 pb-2">
                <nav class="mt-0">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                      <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home">Pending</button>
                      <button class="nav-link" id="nav-withdraw-tab" data-bs-toggle="tab" data-bs-target="#nav-withdraw" type="button" role="tab" aria-controls="nav-withdraw">Approved</button>
                      <button class="nav-link" id="nav-bonus-tab" data-bs-toggle="tab" data-bs-target="#nav-bonus" type="button" role="tab" aria-controls="nav-bonus">Rejected</button>
                      <button class="nav-link" id="nav-revision-tab" data-bs-toggle="tab" data-bs-target="#nav-revision" type="button" role="tab" aria-controls="nav-revision">Asked Revision</button>
                    </div>
                </nav>
                    ...
                    <div class="pendding-task-area mt-2">
                      <div class="table-responsive">
                        <table class="table table-bordered">
                          ...
                          <tbody>
                            @foreach ($task->submittedProofs->whereIn('status', [0,4])->sortByDesc('id') as $proof)
                            <tr>
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" wire:model.live="batchSelectedProofs" type="checkbox" value="{{ $proof->id }}" id="flexCheckDefault">
                                </div>
                              ...
                              <td>
                                  <button class="btn btn-success" wire:click="approve('{{ $proof->id }}', 'approved')">Approve</button> 
                      ...
                      <div class="pendding-task-area mt-2">
                        <div class="table-responsive">
                          <table class="table table-bordered">
                                    ...
                                    <tbody>
                                      @foreach ($task->submittedProofs->where('status', 1)->sortByDesc('id')->paginate(10) as $proof)
                                          <tr>
                                            <td>
                                              <strong>Text Proofs:</strong>
                                              <ol>
                        ...
                        <div class="d-flex">
                          {{ $task->submittedProofs->where('status', 1)->sortByDesc('id')->links() }}
                        </div>
                      </div>                                
                  </div>
                  <!-- Rejected task start -->
                    ...
                    <div class="pendding-task-area mt-2">
                        <div class="table-responsive">
                          <table class="table table-bordered">
                                    ...
                                    <tbody>
                                      @foreach ($task->submittedProofs->whereIn('status', [2, 6])->sortByDesc('id') as $proof)
                                          <tr>
                                            <td>
                                              <div class="form-check">
                                              ...
                                              <strong class="text-danger">Rejection Reason You selected:</strong>
                                              <p>{{ $proof->revisionApprovalReason->selected_reason }}</p>
                                              <strong class="text-danger">Your Rejection Comment:</strong>
